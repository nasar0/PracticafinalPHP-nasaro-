    ...
    <main class="container mt-4">
        ...
        <section class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="../CONTROLADOR/listaprestamos.php?action=insert" method="post" enctype="multipart/form-data" class="border p-4 rounded shadow-sm">
                    <div class="mb-3">
                        <label for="titulo" class="form-label">Amigo:</label>
                    ...
                    <div class="mb-3">
                        <label for="plataforma" class="form-label">Juego:</label>
                    ...
                    <div class="mb-3">
                        <label for="anio_lanzamiento" class="form-label">Dia:</label>
